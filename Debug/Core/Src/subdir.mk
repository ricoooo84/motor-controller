...
C_SRCS += \
../Core/Src/adc_dma_driver.c \
../Core/Src/control_driver.c \
...
OBJS += \
./Core/Src/adc_dma_driver.o \
./Core/Src/control_driver.o \
...
C_DEPS += \
./Core/Src/adc_dma_driver.d \
./Core/Src/control_driver.d \
...
clean-Core-2f-Src:
	-$(RM) ./Core/Src/adc_dma_driver.cyclo ./Core/Src/adc_dma_driver.d ./Core/Src/adc_dma_driver.o ./Core/Src/adc_dma_driver.su ./Core/Src/control_driver.cyclo ./Core/Src/control_driver.d ./Core/Src/control_driver.o ./Core/Src/control_driver.su ./Core/Src/encoder_driver.cyclo ./Core/Src/encoder_driver.d ./Core/Src/encoder_driver.o ./Core/Src/encoder_driver.su ./Core/Src/freertos.cyclo ./Core/Src/freertos.d ./Core/Src/freertos.o ./Core/Src/freertos.su ./Core/Src/main.cyclo ./Core/Src/main.d ./Core/Src/main.o ./Core/Src/main.su ./Core/Src/motor.cyclo ./Core/Src/motor.d ./Core/Src/motor.o ./Core/Src/motor.su ./Core/Src/pid.cyclo ./Core/Src/pid.d ./Core/Src/pid.o ./Core/Src/pid.su ./Core/Src/pwm_driver.cyclo ./Core/Src/pwm_driver.d ./Core/Src/pwm_driver.o ./Core/Src/pwm_driver.su ./Core/Src/stm32f4xx_hal_msp.cyclo ./Core/Src/stm32f4xx_hal_msp.d ./Core/Src/stm32f4xx_hal_msp.o ./Core/Src/stm32f4xx_hal_msp.su ./Core/Src/stm32f4xx_hal_timebase_tim.cyclo ./Core/Src/stm32f4xx_hal_timebase_tim.d ./Core/Src/stm32f4xx_hal_timebase_tim.o ./Core/Src/stm32f4xx_hal_timebase_tim.su ./Core/Src/stm32f4xx_it.cyclo ./Core/Src/stm32f4xx_it.d ./Core/Src/stm32f4xx_it.o ./Core/Src/stm32f4xx_it.su ./Core/Src/syscalls.cyclo ./Core/Src/syscalls.d ./Core/Src/syscalls.o ./Core/Src/syscalls.su ./Core/Src/sysmem.cyclo ./Core/Src/sysmem.d ./Core/Src/sysmem.o ./Core/Src/sysmem.su ./Core/Src/system_stm32f4xx.cyclo ./Core/Src/system_stm32f4xx.d ./Core/Src/system_stm32f4xx.o ./Core/Src/system_stm32f4xx.su ./Core/Src/uart_driver.cyclo ./Core/Src/uart_driver.d ./Core/Src/uart_driver.o ./Core/Src/uart_driver.su
